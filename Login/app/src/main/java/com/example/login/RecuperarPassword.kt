...
import com.example.login.databinding.ActivityRecuperarPasswordBinding
import com.google.firebase.auth.FirebaseAuth

class RecuperarPassword : AppCompatActivity() {
    private val binding by lazy { ActivityRecuperarPasswordBinding.inflate(layoutInflater) }
